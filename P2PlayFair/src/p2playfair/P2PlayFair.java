...
class MainLogic {
    ...
    String decryptCharacter(String cipher) {
    ...
    String decryptText(String cipherText, String key) {
        ...
        for (int i = 0; i < len - 1; i = i + 2) {
            plainText += decryptCharacter(cipherText.substring(i, i + 2));
            plainText += " ";
...
public class P2PlayFair {
    
    public static void main(String[] args) {
        
        MainLogic pf = new MainLogic();
        ...
        cipherText = pf.encryptText(plainText,key);
             
        System.out.println("Encrypted text:");
        System.out.println("----------------------------------\n" + cipherText);
        System.out.println("----------------------------------");
        String encryptedText = pf.decryptText(cipherText, key);
